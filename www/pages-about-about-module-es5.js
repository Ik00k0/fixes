(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-about-about-module"], {
  ...
  function srcAppPagesAboutAboutPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AboutPage = class AboutPage {
      ...
      setPerson(user) {
        this.http.post('http://cs.ashesi.edu.gh/~godlove_otoo/MindITBackend/view/getuser.php', {
          user
        }, {}).then(data => {
          ...
          this.gender = this.cont_datda[0]['gender']; //alert(this.personData);
        }).catch(error => {
          alert(error.status);
      ...
      updatePerson() {
        ...
        this.http.post('http://cs.ashesi.edu.gh/~godlove_otoo/MindITBackend/view/updateuser.php', {
          ...
          phoneNum: this.p_num,
          email: this.u_mail,
          EContactName: this.c_name,
          EContactNum: this.c_num
        }, {}) //add all the details
        .then(data => {
          alert("information updated"); //alert(JSON.parse(data.data));
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_2__["HTTP"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])], AboutPage);
    /***/
  }
}]);
